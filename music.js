...
/////////////////////////////////////////////////////////////////
client.on('ready', () => client.user.setActivity(`${prefix}play , ${prefix}search.`, {type: "Playing"}))
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////
...
client.on('message', async function(message) {
    ...
    if (message.content.startsWith(`${prefix}eval`)) {
       ...
       if(!args) return message.channel.send({embed: {
           ...
           description: `🏳  \`\`${prefix}help <command>\`\` | عدد الاوامر: **${music.map(m => m.name).length + info.map(m => m.name).length}**`,
           fields: [
               {
                name: '❯ اوامر الاغاني',
      ...
      if(message.content.startsWith(`${prefix}info`)) {
        ...
        .setURL("https://sk-bots.netlify.com")
    ...
    } else if (mess.startsWith(prefix + "skip") || mess.startsWith(prefix+"تخطي")) {
...
//
async function skip_song(message) { await guilds[message.guild.id].dispatcher.end();
}
